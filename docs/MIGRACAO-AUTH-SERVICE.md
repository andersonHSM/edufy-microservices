...
## Objetivo
Centralizar a lógica de autenticação e gerenciamento de tokens JWT, migrando as funcionalidades do monolito (`UserController`) para o microsserviço `auth-api`.
