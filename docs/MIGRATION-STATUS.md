...
| `Job`  | `enroll-student`             | **[OK]**    | `@MessagePattern('enroll_student_request')` | N/A                               | Substitui o job `pg-boss` do monolito por um consumidor RabbitMQ para processar a matrícula de forma assíncrona após a compra. **[Protocolo: RabbitMQ]** |
